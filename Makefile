...
all: signal_handler signal_alarm signal_segfault signal_sigaction recv_signal send_signal
...
clean:
	rm -f *.o signal_handler signal_alarm signal_segfault signal_sigaction recv_signal send_signal
